...
Установка не создаёт учётные данные сервисов. При первом использовании выбранный Skill запускает `doctor` и при необходимости помогает пользователю создать собственные учётные данные. Не вставляйте ключи, секреты или токены в чат.
